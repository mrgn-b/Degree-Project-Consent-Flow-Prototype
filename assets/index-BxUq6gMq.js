...
var assetsURL = function(dep) {
	return "/Degree-Project-Consent-Flow-Prototype/" + dep;
};
var seen = {};
...
//#endregion
//#region src/views/mainPageView.jsx
var import_client = require_client();
var import_jsx_runtime = require_jsx_runtime();
function MainPageView() {
	const navigate = useNavigate();
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: "flex h-screen flex-col items-center justify-center bg-gradient-to-br from-slate-50 to-blue-100",
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
			className: "mb-12 text-5xl font-bold tracking-tight text-gray-800",
			children: "Consent Flow"
...
//#endregion
//#region src/presenters/mainPagePresenter.jsx
function MainPage() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(MainPageView, {});
}
//#endregion
//#region src/modals/consentRequestModal.jsx
function ConsentRequestModal({ serviceId, serviceName, duration, purposes, thirdParties, onClose, updateConsent }) {
	const [editableConsent, setEditableConsent] = (0, import_react.useState)({
		serviceId,
	...
	const allRequiredGranted = editableConsent.purposes.filter((p) => p.required).every((p) => p.granted);
	...
	const handlePurposeChange = (purposeId) => {
		setEditableConsent((prev) => ({
			...prev,
			purposes: prev.purposes.map((p) => p.id === purposeId ? {
				...p,
				granted: !p.granted
			} : p)
		}));
	...
	const handleAcceptCategory = (category) => {
		setEditableConsent((prev) => ({
			...prev,
			purposes: prev.purposes.map((p) => p.category === category ? {
				...p,
				granted: true
			} : p)
		}));
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "font-semibold text-gray-800 min-w-[100px]",
						children: categoryLabel
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "flex-1 border-t border-gray-400" })
				]
			}), isExpanded && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "space-y-4 pb-4",
				children: purposes.map((p) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						}), p.dataCategories?.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("ul", {
							className: "mt-2 space-y-1",
							children: p.dataCategories.map((dc, idx) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", {
								className: "text-xs text-gray-500 flex items-center gap-2",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "w-1 h-1 rounded-full bg-gray-400" }), dc]
							}, idx))
						})]
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						}), p.required && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							className: "absolute hidden group-hover:block bottom-full right-0 mb-2 bg-gray-800 text-white text-xs rounded px-3 py-1 whitespace-nowrap z-[9999]",
							children: "Required"
						})]
					})]
				}) }, p.id))
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
					...
					disabled: allGranted,
					className: `px-4 py-2 text-sm font-medium border-2 border-gray-800 rounded-lg transition ${allGranted ? "bg-gray-100 text-gray-400 border-gray-300 cursor-not-allowed" : "text-gray-800 hover:bg-gray-50 cursor-pointer"}`,
					children: ["Accept all ", categoryLabel]
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
					onClick: () => handleRejectCategory(categoryKey),
					disabled: allRejected,
					className: `px-4 py-2 text-sm font-medium border-2 border-gray-800 rounded-lg transition ${allRejected ? "bg-gray-100 text-gray-400 border-gray-300 cursor-not-allowed" : "text-gray-800 hover:bg-gray-50 cursor-pointer"}`,
					children: ["Reject all ", categoryLabel]
				})]
			})] })]
		});
	};
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			children: [
				...
				editableConsent.thirdParties.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "mb-6",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						...
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("ul", {
							className: "space-y-2",
							children: editableConsent.thirdParties.map((t) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", {
								className: "text-sm text-gray-700 flex items-center gap-2",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "w-1.5 h-1.5 rounded-full bg-gray-400" }), t.name]
							}, t.id))
						})
					})]
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
						...
						className: `px-6 py-2 text-sm font-medium rounded-lg transition ${allRequiredGranted ? "bg-blue-600 text-white hover:bg-blue-700 cursor-pointer" : "bg-gray-400 text-gray-600 cursor-not-allowed"}`,
						children: "Agree"
					})]
				})
			]
...
//#endregion
//#region src/modals/ConsentDetailsModal.jsx
function ConsentDetailsModal({ consent, providerMap, requestMap, getConsentStatus, updateConsent, onClose, isNewConsent = false, onRevoke }) {
	const [editableConsent, setEditableConsent] = (0, import_react.useState)(consent);
	const [originalConsent, setOriginalConsent] = (0, import_react.useState)(consent);
	const [expandedCategories, setExpandedCategories] = (0, import_react.useState)({
		required: true,
		functional: true,
		advertising: true
	...
	const allRequiredGranted = editableConsent.purposes.filter((p) => p.required).every((p) => p.granted);
	const hasChanges = JSON.stringify(editableConsent.purposes) !== JSON.stringify(originalConsent.purposes);
	const isSaveEnabled = allRequiredGranted && hasChanges;
	const isEditable = isNewConsent || getConsentStatus(editableConsent) === "active";
	const handlePurposeChange = (purposeId) => {
		setEditableConsent((prev) => ({
			...prev,
			purposes: prev.purposes.map((p) => p.id === purposeId ? {
	...
	const CategorySection = ({ categoryKey, categoryLabel, purposes }) => {
		...
		return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			}), isExpanded && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "space-y-4 pb-4",
					children: purposes.map((p) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "flex justify-between items-start gap-3",
						children: [
							...
							isEditable && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
									...
									className: `w-5 h-5 accent-blue-600 ${categoryKey === "required" ? "cursor-not-allowed opacity-50" : "cursor-pointer"}`
								}), p.required && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
									className: "absolute hidden group-hover:block bottom-full right-0 mb-2 bg-gray-800 text-white text-xs rounded px-3 py-1 whitespace-nowrap z-[9999]",
									children: "Required"
								})]
							}),
							!isEditable && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								className: "text-sm font-medium text-gray-700 mt-0.5",
								children: p.granted ? "Granted" : "Denied"
							})
						]
					}) }, p.id))
				}),
				isEditable && categoryKey !== "required" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "pb-4 flex gap-3",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
						onClick: () => handleAcceptCategory(categoryKey),
						disabled: allGranted,
				...
				isEditable && categoryKey === "required" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						...
						children: "Required fields cannot be disabled. The consent must include these to remain active."
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
						onClick: onRevoke,
	...
	const serviceName = providerMap[editableConsent.serviceId]?.name || requestMap[editableConsent.serviceId]?.name || "Unknown Service";
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: "fixed inset-0 z-50 flex items-center justify-center",
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			className: "absolute inset-0 bg-black/40",
			...
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
							className: "text-2xl font-semibold text-gray-900",
							children: isNewConsent ? "Create Consent" : "Consent Details"
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
							className: "text-sm text-gray-600 mt-2",
							children: [
						...
						!isNewConsent && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
							className: "text-sm text-gray-600 mt-1",
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", { children: "Consent ID:" }),
								" ",
								editableConsent.id
							]
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
							...
							children: [
								...
								" ",
								getConsentStatus(editableConsent)
							]
						})] })
					]
				}),
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
						...
						onClick: handleSaveChanges,
						disabled: isNewConsent ? !allRequiredGranted : !isSaveEnabled,
						className: `px-6 py-2 text-sm font-medium rounded-lg transition ${(isNewConsent ? allRequiredGranted : isSaveEnabled) ? "bg-blue-600 text-white hover:bg-blue-700 cursor-pointer" : "bg-gray-400 text-gray-600 cursor-not-allowed"}`,
						children: isNewConsent ? "Agree" : "Save Changes"
					})]
				})
			]
		})]
...
//#endregion
//#region src/views/servicePageView.jsx
function ServicePageView(props) {
	...
	const [serviceToAccept, setServiceToAccept] = (0, import_react.useState)(null);
	const [selectedConsentToView, setSelectedConsentToView] = (0, import_react.useState)(null);
	const [selectedConsentToRevoke, setSelectedConsentToRevoke] = (0, import_react.useState)(null);
	...
	function handleAccessService(provider) {
		if (provider.status === "inactive") setServiceToAccept(provider);
	}
	function handleManageConsent(provider) {
		const consent = consents.find((c) => c.serviceId === provider.id && c.metadata.source === "Service Page" && getConsentStatus(c) === "active");
		if (consent) setSelectedConsentToView(consent);
	}
	function handleCreateConsent(consentData) {
		createConsent(consentData.serviceId, consentData.purposes, consentData.thirdParties, "Service Page");
		...
		return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
					className: `mb-4 px-2 py-1 rounded-full text-sm font-medium ${provider.status === "active" ? "bg-green-100 text-green-700" : "bg-gray-100 text-gray-500"}`,
					children: provider.status === "active" ? "Active" : "Inactive"
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "flex gap-2",
					children: provider.status === "inactive" ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: "flex flex-col min-h-screen items-center bg-gradient-to-br from-slate-50 to-blue-50 p-8",
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
				className: "text-4xl font-bold text-gray-800 mb-4",
				children: "Available Service Providers"
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				className: "text-gray-600 mb-8 text-center max-w-xl",
				children: "Connect and access services."
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: activeProviders.map(renderProviderCardACB)
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
				className: "text-2xl font-semibold text-gray-700 mb-4 text-center",
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: inactiveProviders.map(renderProviderCardACB)
			}),
			serviceToAccept && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ConsentRequestModal, {
			...
			selectedConsentToView && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ConsentDetailsModal, {
			...
			selectedConsentToRevoke && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
							...
							children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
									...
									children: providerMap[selectedConsentToRevoke.serviceId].name
								}),
...
//#endregion
//#region src/stores/useServiceProviderStore.js
var useServiceProviderStore = create(persist((set, get) => ({
	providers: model.serviceProviders,
	toggleStatus: (id) => {
		set({ providers: get().providers.map((p) => p.id === id ? {
			...p,
...
//#endregion
//#region src/stores/useDataRequestsStore.js
var useDataRequestsStore = create(persist((set, get) => ({
	dataRequests: model.dataRequests,
	setStatus: (id, status) => {
		set((state) => ({ dataRequests: state.dataRequests.map((dr) => dr.id === id ? {
			...dr,
			status
		} : dr) }));
	}
...
function calculateExpirationDate(duration) {
	...
	switch (unit) {
		case "instant":
			...
			break;
		case "minutes":
			expiresAt += value * 60 * 1e3;
			break;
		case "hours":
			expiresAt += value * 60 * 60 * 1e3;
			break;
		case "days":
			expiresAt += value * 24 * 60 * 60 * 1e3;
			break;
		case "months":
			const dateMonth = new Date(now);
			dateMonth.setMonth(dateMonth.getMonth() + value);
			expiresAt = dateMonth.getTime();
			break;
		case "years":
			const dateYear = new Date(now);
			dateYear.setFullYear(dateYear.getFullYear() + value);
			expiresAt = dateYear.getTime();
			break;
		default:
...
//#endregion
//#region src/stores/useConsentStore.js
var useConsentStore = create(persist((set, get) => {
	...
	const scheduleExpiration = (consent) => {
		...
		if (msUntilExpiration > 0) {
			...
			expirationTimers[consent.id] = setTimeout(() => {
				...
				set((state) => {
					const updatedConsents = state.consents.map((c) => c.id === consent.id ? {
						...c,
						timestamps: {
							...c.timestamps,
							updatedAt: nowISO
				...
				consent.metadata.source === "Service Page" ? useServiceProviderStore.getState().toggleStatus(consent.serviceId) : useDataRequestsStore.getState().setStatus(consent.serviceId, "completed");
	...
	return {
		...
		toggleConsentRevocation: (id) => {
			set((state) => {
				...
				return {
					...
					consentActions: newAction ? [...state.consentActions, newAction] : state.consentActions
				};
			});
		},
		createConsent: (serviceId, purposes = [], thirdParties = [], source, duration = {
			value: 1,
			unit: "years"
		}) => {
			const now = (/* @__PURE__ */ new Date()).toISOString();
			new Date((/* @__PURE__ */ new Date()).setFullYear((/* @__PURE__ */ new Date()).getFullYear() + 1)).toISOString();
			...
			const newConsent = {
				...
				thirdParties: thirdParties.map((t) => ({
					...t,
					granted: t.granted
				})),
				status: "active",
		...
		updateConsent: (updatedConsent) => {
			...
			const now = (/* @__PURE__ */ new Date()).toISOString();
			const purposeChanges = updatedConsent.purposes.map((p) => {
			...
			const thirdPartyChanges = updatedConsent.thirdParties.map((t) => {
			...
			set((state) => ({
				consents: state.consents.map((c) => c.id === updatedConsent.id ? {
					...updatedConsent,
					timestamps: {
			...
			if (originalConsent.timestamps.expiresAt !== updatedConsent.timestamps.expiresAt) scheduleExpiration(updatedConsent);
		},
		...
		getStatus: (consent) => {
			...
			if (consent.timestamps?.expiresAt && new Date(consent.timestamps.expiresAt) < /* @__PURE__ */ new Date()) return "expired";
			return "active";
		},
		getActiveCount: () => get().consents.filter((c) => get().getStatus(c) === "active").length,
		getRevokedCount: () => get().consents.filter((c) => get().getStatus(c) === "revoked").length,
...
useConsentStore.subscribe((state) => state.consents, (consents, previous) => {
	consents.forEach((c) => {
		...
		if (!prev || prev.timestamps.expiresAt !== c.timestamps.expiresAt) useConsentStore.getState().scheduleAllExpirations();
	});
});
//#endregion
//#region src/presenters/servicePagePresenter.jsx
function ServicePage(props) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ServicePageView, {
		providers: useServiceProviderStore((state) => state.providers),
		changeServiceStatus: useServiceProviderStore((state) => state.toggleStatus),
		createConsent: useConsentStore((state) => state.createConsent),
		consents: useConsentStore((state) => state.consents),
		getConsentStatus: useConsentStore((state) => state.getStatus),
		updateConsent: useConsentStore((state) => state.updateConsent),
		toggleConsentStatus: useConsentStore((state) => state.toggleConsentRevocation)
	});
}
//#endregion
//#region src/views/consentDashboardView.jsx
function ConsentDashboardView(props) {
	const consents = props.consents;
	const changeServiceStatus = props.changeServiceStatus;
	...
	const [selectedConsentToRevoke, setSelectedConsentToRevoke] = (0, import_react.useState)(null);
	const [editableConsent, setEditableConsent] = (0, import_react.useState)(null);
	...
	const confirmRevoke = () => {
		...
		selectedConsentToRevoke.metadata.source === "Service Page" ? changeServiceStatus(selectedConsentToRevoke.serviceId) : setRequestStatus(selectedConsentToRevoke.serviceId, "revoked");
		setSelectedConsentToRevoke(null);
	...
	function SummaryCard({ title, count, color }) {
		return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				...
				children: count
			})] }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: `w-10 h-10 rounded-full ${{
	...
	const getSortValue = (consent, key) => {
		switch (key) {
			case "service": return consent.metadata.source === "Service Page" ? props.providerMap[consent.serviceId]?.name || "" : requestMap[consent.serviceId]?.name || "";
			case "status": return getStatusSortOrder(props.getConsentStatus(consent));
			case "updated": return new Date(consent.timestamps.updatedAt).getTime();
			case "expires": return new Date(consent.timestamps.expiresAt).getTime();
			case "revoked": return consent.timestamps.revokedAt ? new Date(consent.timestamps.revokedAt).getTime() : Infinity;
			default: return "";
		}
	};
	let filteredConsents = statusFilter === "all" ? reversedConsents : reversedConsents.filter((c) => props.getConsentStatus(c) == statusFilter);
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
					...
					children: "Manage and monitor your consents"
				})] })
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: [
					...
					className: `px-3 py-1 rounded text-sm ${statusFilter === filter ? "bg-blue-600 text-white" : "bg-gray-100"}`,
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SummaryCard, {
						title: "Active",
						count: props.activeConsentCount,
						color: "green"
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SummaryCard, {
						title: "Revoked",
						count: props.inactiveConsentCount,
						color: "gray"
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SummaryCard, {
						title: "Expired",
						count: props.expiredConsentCount,
						color: "red"
					})
				]
			}),
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("thead", {
						...
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("tr", { children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("th", {
								...
								children: ["Service ", sortKey === "service" && (sortDirection === "asc" ? "↑" : "↓")]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("th", {
								className: "p-4 cursor-pointer hover:bg-gray-100 transition select-none",
								onClick: () => handleSort("status"),
								children: ["Status ", sortKey === "status" && (sortDirection === "asc" ? "↑" : "↓")]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("th", {
								className: "p-4 cursor-pointer hover:bg-gray-100 transition select-none",
								onClick: () => handleSort("updated"),
								children: ["Updated ", sortKey === "updated" && (sortDirection === "asc" ? "↑" : "↓")]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("th", {
								className: "p-4 cursor-pointer hover:bg-gray-100 transition select-none",
								onClick: () => handleSort("expires"),
								children: ["Expires ", sortKey === "expires" && (sortDirection === "asc" ? "↑" : "↓")]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("th", {
								className: "p-4 cursor-pointer hover:bg-gray-100 transition select-none",
								onClick: () => handleSort("revoked"),
								children: ["Revoked At ", sortKey === "revoked" && (sortDirection === "asc" ? "↑" : "↓")]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("th", { className: "p-4" })
						] })
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("tbody", { children: filteredConsents.map((c) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("tr", {
						className: "border-t",
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
								className: "p-4",
								children: c.metadata.source === "Service Page" ? props.providerMap[c.serviceId].name : requestMap[c.serviceId].name
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
								className: "p-4",
								children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
									className: `px-2 py-1 text-xs rounded-full ${statusStyles[props.getConsentStatus(c)]}`,
									children: props.getConsentStatus(c)
								})
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
								className: "p-4",
								children: new Date(c.timestamps.updatedAt).toLocaleString()
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
								className: "p-4",
								children: new Date(c.timestamps.expiresAt).toLocaleString()
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
								className: "p-4",
								children: c.timestamps.revokedAt ? new Date(c.timestamps.revokedAt).toLocaleString() : "-"
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("td", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
									...
									children: "View"
								}), props.getConsentStatus(c) === "active" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
							...
							children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
									className: "font-medium",
									children: selectedConsentToRevoke.metadata.source === "Service Page" ? props.providerMap[selectedConsentToRevoke.serviceId].name : requestMap[selectedConsentToRevoke.serviceId].name
								}),
								"?",
			...
			editableConsent && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ConsentDetailsModal, {
...
//#endregion
//#region src/presenters/consentDashboardPresenter.jsx
function ConsentDashboard() {
	...
	const providerMap = (0, import_react.useMemo)(() => {
		return Object.fromEntries(providers.map((p) => [p.id, p]));
	}, [providers]);
	const requestMap = (0, import_react.useMemo)(() => {
		return Object.fromEntries(dataRequests.map((r) => [r.id, r]));
	}, [dataRequests]);
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ConsentDashboardView, {
		consents,
		getConsentStatus,
		toggleConsentStatus,
...
//#endregion
//#region src/views/consentHistoryPageView.jsx
function ConsentHistoryPageView(props) {
	...
	const actions = [...props.actions].sort((a, b) => new Date(b.timestamp) - new Date(a.timestamp));
	const formatDate = (ts) => new Date(ts).toLocaleString();
	const isNewSinceLastVisit = (actionTimestamp) => {
		return new Date(actionTimestamp).getTime() > lastVisitTime || lastVisitTime === Date.now();
	};
	const getActionLabel = (type) => {
		switch (type) {
			case "created": return "Consent Created";
			case "updated": return "Preferences Updated";
			case "revoked": return "Consent Revoked";
			case "unrevoked": return "Consent Unrevoked";
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				...
				children: "See all your consent actions"
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "flex gap-2 mb-6 flex-wrap",
				children: [
					...
					className: `px-3 py-1 rounded text-sm ${timeFilter === filter ? "bg-blue-600 text-white" : "bg-gray-100"}`,
					onClick: () => setTimeFilter(filter),
					children: filter === "all" ? "All" : filter === "1h" ? "Last hour" : filter === "1d" ? "Last day" : "Last month"
				}, filter))
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "relative border-l border-gray-200 pl-6 space-y-6",
				children: [filteredActions.length === 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					className: "text-gray-500 text-sm",
					children: "No consent actions in this time range."
				}), filteredActions.map((action) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "relative",
					children: [isNewSinceLastVisit(action.timestamp) && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "absolute -left-[9px] top-1 w-4 h-4 bg-blue-600 rounded-full border-2 border-white" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
									...
									children: [
										...
										" for ",
										action.consentType === "service" ? providerMap[consentMap[action.consentId].serviceId].name : requestMap[consentMap[action.consentId].serviceId].name
									]
								}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
									className: "text-xs text-gray-500",
									children: formatDate(action.timestamp)
								})]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
								...
								children: [
									action.actor,
									" via ",
									action.metadata?.source || "unknown"
								]
							}),
							action.changes && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "mt-3 space-y-2",
								children: [action.changes.purposes?.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
									className: "text-sm font-semibold text-gray-600",
									children: "Purposes"
								}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("ul", {
									className: "mt-1 space-y-1",
									children: action.changes.purposes.map((p) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", {
										className: "flex justify-between text-sm",
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: p.description || p.id }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { children: [
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
												className: p.from ? "text-green-600" : "text-red-500",
												children: p.from ? "Granted" : "Denied"
											}),
											" → ",
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
												className: p.to ? "text-green-600" : "text-red-500",
												children: p.to ? "Granted" : "Denied"
											})
										] })]
									}, p.id))
								})] }), action.changes.thirdParties?.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
									className: "text-sm font-semibold text-gray-600",
									children: "Third Parties"
								}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("ul", {
									className: "mt-1 space-y-1",
									children: action.changes.thirdParties.map((t) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", {
										className: "flex justify-between text-sm",
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: t.id }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { children: [
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
												className: p.from ? "text-green-600" : "text-red-500",
												children: p.from ? "Granted" : "Denied"
											}),
							...
							!action.changes && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								className: "text-sm text-gray-500 mt-2",
								children: "No detailed changes recorded"
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
								className: "text-xs text-gray-500 mt-2",
								children: ["Consent ID: ", action.consentId]
							})
						]
					})]
				}, action.id))]
...
//#endregion
//#region src/hooks/useConsentHistoryLastVisit.js
function useConsentHistoryLastVisit() {
	const [lastVisitTime] = (0, import_react.useState)(() => {
...
//#endregion
//#region src/presenters/consentHistoryPagePresenter.jsx
function ConsentHistoryPage() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ConsentHistoryPageView, {
		actions,
		consentMap: (0, import_react.useMemo)(() => {
			return Object.fromEntries(consents.map((c) => [c.id, c]));
		}, [consents]),
		providerMap: (0, import_react.useMemo)(() => {
			return Object.fromEntries(providers.map((p) => [p.id, p]));
		}, [providers]),
		requestMap: (0, import_react.useMemo)(() => {
			return Object.fromEntries(dataRequests.map((r) => [r.id, r]));
		}, [dataRequests]),
		lastVisitTime
	});
...
//#endregion
//#region src/views/dataRequestsPageView.jsx
function DataRequestsPageView(props) {
	const dataRequests = props.dataRequests;
	const setStatus = props.setStatus;
	const createConsent = props.createConsent;
	const [selectedRequest, setSelectedRequest] = (0, import_react.useState)(null);
	const [isRequestModalOpen, setIsRequestModalOpen] = (0, import_react.useState)(false);
	const [selectedRequestToAccept, setSelectedRequestToAccept] = (0, import_react.useState)(null);
	const [statusFilter, setStatusFilter] = (0, import_react.useState)("all");
	const [selectedRequestToRevoke, setSelectedRequestToRevoke] = (0, import_react.useState)(null);
	const filteredOffers = statusFilter === "all" ? dataRequests : dataRequests.filter((r) => r.status == statusFilter);
	const statusStyles = {
	...
	function handleCreateConsent(consentData) {
		createConsent(consentData.serviceId, consentData.purposes, consentData.thirdParties, "Data Offers Page", consentData.duration);
		setStatus(consentData.serviceId, "active");
		setIsRequestModalOpen(false);
	}
	const confirmRevoke = () => {
		const relevantConsent = props.consents?.find((c) => c.serviceId === selectedRequestToRevoke.id && c.metadata.source !== "Service Page");
		if (relevantConsent) props.toggleConsentStatus(relevantConsent.id);
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
				...
				className: "text-gray-500 text-sm",
				children: "Share your data in exchange for rewards"
			})] }),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "flex gap-2 mb-6 flex-wrap",
				children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: filteredOffers.map((req) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							...
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
								className: "font-medium",
								children: ["Duration: ", req.duration.unit !== "instant" ? req.duration.value + " " + req.duration.unit : "Instant reward"]
							})
						})
					] }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "mt-4 flex justify-between items-center",
						children: [
							req.status !== "available" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
							...
							req.status !== "available" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
			...
			selectedRequest && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "fixed inset-0 z-50 flex items-center justify-center",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "absolute inset-0 bg-black/40",
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								...
								children: selectedRequest.purposes?.map((p) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", { children: ["• ", p.description] }, p.id))
							})]
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "mt-4",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								...
								children: selectedRequest.thirdParties?.map((p) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", { children: ["• ", p.name] }, p.id))
							})]
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "flex justify-end gap-3 mt-6",
							children: [
								...
								selectedRequest.status === "active" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
									onClick: () => setSelectedRequestToRevoke(selectedRequest),
									className: "px-4 py-2 text-sm rounded-lg bg-red-600 text-white",
									children: "Revoke"
								}),
								selectedRequest.status === "available" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
									onClick: () => {
			...
			selectedRequestToRevoke && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "fixed inset-0 z-[60] flex items-center justify-center",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "absolute inset-0 bg-black/40",
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
							...
							children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
									className: "font-medium",
									children: selectedRequestToRevoke.name
								}),
			...
			isRequestModalOpen && selectedRequestToAccept && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ConsentRequestModal, {
...
//#endregion
//#region src/presenters/dataRequestsPagePresenter.jsx
function DataRequestsPage() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DataRequestsPageView, {
		dataRequests: useDataRequestsStore((state) => state.dataRequests),
		setStatus: useDataRequestsStore((state) => state.setStatus),
		createConsent: useConsentStore((state) => state.createConsent),
		toggleConsentStatus: useConsentStore((state) => state.toggleConsentRevocation),
		setRequestStatus: useDataRequestsStore((state) => state.setStatus),
		consents: useConsentStore((state) => state.consents)
	});
}
//#endregion
//#region src/root.jsx
function Root(props) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(HashRouter, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("nav", {
